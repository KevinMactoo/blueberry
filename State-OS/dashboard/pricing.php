                                ...
                                <div class="page-title-heading">
                                    ...
                                    <div> Dashboard
                                        ...
                                        <?php else:?>
                                            ...
                                            <ol class="breadcrumb">
                                            <li class="active breadcrumb-item" aria-current="page">Home | <b>Pricing</b></li>
                                            </ol>
                                            </nav>
                                        <?php endif; ?>
                                        </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <?php include (ROOT_PATH . "/app/helpers/formErrors.php")?>
	                        ...
	                        <div class="form-group">
	                        	...
	                        	<input type="text" name="title" class="form-control" value="<?php echo $aboutus_title;  ?>">
	                        </div>

	                        <div class="form-group">
	                        	<label for="post_subtitles">About Us subtitles</label>
	                        	<input type="text" name="subtitle" class="form-control" value="<?php echo  $aboutus_subtitle; ?>">
	                        </div>
	                        ...
	                        <div class="input-group">
                                	...
                                	<div class="form-group">
                                		...
                                		<textarea  class="form-control" name="content" id="" cols="30" rows="10"><?php  echo $aboutus_content;  ?>
                                		</textarea>
                                	</div>
