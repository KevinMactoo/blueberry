                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <?php if ($_SESSION['su_admin']): ?>
                                    ...
                                    <li>
                                        <a href="<?php echo BASE_URL . '/dashboard/users/create.php'  ?>" class="mm-active">
                                            <i class="metismenu-icon">
                                            </i>Add new user
                                        </a>
                                    </li>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="mb-3 card">
                            <div class="card-header-tab card-header-tab-animation card-header">
                                ...
                                <ul class="nav">
                                    <li class="nav-item"><a href="<?php echo BASE_URL . '/dashboard/users/index.php'  ?>" class=" nav-link">View</a></li>
