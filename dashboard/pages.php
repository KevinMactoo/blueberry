...
include ('../app/controllers/aboutus.php');
                        ...
                        <div class="table-responsive" style="padding-bottom:50px;">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button type="button" id="PopoverCustomT-1" class="btn btn-primary btn-sm" href="#recording" data-toggle="modal">Details</button>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button type="button" id="PopoverCustomT-1" class="btn btn-primary btn-sm" href="#mixing" data-toggle="modal">Details</button>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $services_booking;  ?></td>
                                                <td class="text-center">
                                                    <div class="badge badge-success">live</div>
                                                </td>
                                                <td class="text-center">
...
<!-- Edit mixing -->
<div class="modal fade" id="mixing">
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	<label for="address" class="col-sm-3 control-label">Mixing</label>

                  	<div class="col-sm-9">
                      <textarea class="form-control" name="address" id="address"><?php echo $services_mixing;?></textarea>
                  	</div>
                </div>
...
<!-- Edit Recording -->
<div class="modal fade" id="recording">
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	<label for="address" class="col-sm-3 control-label">Recording</label>

                  	<div class="col-sm-9">
                      <textarea class="form-control" name="address" id="address"><?php echo $services_recording;?></textarea>
                  	</div>
                </div>
        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                      <textarea class="form-control" name="address" id="address"><?php echo $services_booking;?></textarea>
                  	</div>
                </div>
