                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <ul>
                                <li>
                                    <a href="<?php echo BASE_URL . '/dashboard/users/view.php'  ?>" class="mm-active">
                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                    <button type="button" data-toggle="tooltip" title="This page shows your user details. To edit click on edit details on the menu" data-placement="bottom" class="btn-shadow mr-3 btn btn-dark">
                        ...
                        <div class="mb-3 card">
                            <div class="card-header-tab card-header-tab-animation card-header">
                                ...
                                <ul class="nav">
                                    ...
                                    <li class="nav-item"><a href="<?php echo BASE_URL . '/dashboard/users/edit.php'  ?>" class="nav-link second-tab-toggle">Edit</a></li>
                                </ul>
                            </div>
                            <div class="card-body">
                                <div class="tab-content">
                                    <form class="">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12">
                                        <div class="position-relative form-group">
                                            <label for="status" class=""> Bio: </label>
                                            <textarea name="status" id="status" disabled type="text"  class="form-control"><?php if(empty($image_preview['status'])): ?>Hi there! Let's Connect.(Default Status)<?php else: ?><?php echo html_entity_decode($image_preview['status']) ?><?php endif; ?></textarea>
                                        </div>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="mb-3 card">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="text-center">
                                    ...
                                    <?php else: ?>
                                       <?php echo html_entity_decode($image_preview['status']) ?>
                                    <?php endif; ?>
                                    </p>
